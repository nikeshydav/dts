...
class User extends CI_Controller {
  ...
  <span class="sr-only">Error:</span>Enter a valid username and Password!</div>';
        $this->load->view('index', $data);
    }
    ...
    function user_list() {
        ...
        $crud->columns('first_name', 'last_name', 'user_name');
    ...
    function create_member() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($query = $this->Users_model->create_member()) {
                $output = array('output' => "New account has now been created.");//\nAn Email Has been sent to user emailid.
                $this->load->view('queries', $output);
            } else {
                $this->load->view('signup_form');
            }
    ...
    function change_password() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($query = $this->Users_model->change_password()) {
                $output = array('output' => 'Password has been updated.');
                $this->load->view('queries', $output);
            } else {
                $this->load->view('signup_form');
            }
