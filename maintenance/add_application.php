            ...
            <div>
                <form action="" method="post" enctype="multipart/form-data">
                    <table>
                        ...
                        <tr> <td> Registration No. :</td> <td><input type="text" name="app_no" id="app_no" autocomplete="off" /> </td></tr>
                        ...
                        <tr> <td> User :</td> <td><input type="text" name="user_proposed" id="user_proposed" autocomplete="off" /><input type="checkbox" name="proposed" id="proposed" onClick="pro();">Proposed to be used</td></tr>
...
<!--                                <input type="text" name="client_no1" style="width:700px;" id="client_no1" /> -->
                        ...
                        <tr> <td valign="top"> Status Maintenance :</td> <td><div class="status"><p><label for="var1"><select name="status1" id="status"><option value="select">--Select--</option><?php $obj->show_status(); ?></select>
                        ...
                        <tr> <td> ALG File :</td> <td>
                                ...
                                Regn<input type="text" size="10px" name="alg_apln" id="alg_apln" readonly />
