...
function mail_attachment($filename, $path, $mailto, $from_mail, $from_name, $replyto, $subject, $message) {
  ...
  if (!headers_sent()) {
			...
			header("location:send_letter.php?thanks=Your mail has been sent successfully.?sid=$sid");
		} else {
			echo "<script>
			window.location.href='send_letter.php?thanks=Your mail has been sent successfully.&?sid=$sid'
			 </script>";
		}
