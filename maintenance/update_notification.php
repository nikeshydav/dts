...
where a.id='$ides' and g.app_id='$ides' group by a.id");
        ...
        $sql3 = "update notifications set notify_status='1', snooze='". date('Y-m-d') ."' where fid='$notice_id'";
        mysql_query($sql3);
    ...
    if ($_GET['action'] == 'delete') {
        ...
        echo $sql = "update notifications set notify_status='2' , snooze='". date('Y-m-d') ."' where fid='$id'";
        //exit();
        mysql_query($sql);
