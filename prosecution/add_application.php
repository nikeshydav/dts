            ...
            <div>
                <form action="" method="post" enctype="multipart/form-data">
                    <table>
                        ...
                        <tr> <td> Application Number :</td> <td><input type="text" name="app_no" id="app_no" autocomplete="off" /> </td></tr>
                        ...
                        <tr> <td> Use Claim :</td> <td><input type="text" name="user_proposed" id="user_proposed" autocomplete="off" /><input type="checkbox" name="proposed" id="proposed" onClick="pro();">Proposed to be used</td></tr>
...
<tr><td>To</td>
                        ...
                        <tr> <td valign="top"> Status Prosecution :</td> <td><div class="status"><p><label for="var1"><select name="status1" id="status"><option value="select">--Select--</option><?php $obj->show_status(); ?></select>
                        ...
                        <tr> <td style="vertical-align: top;"> Pending Recordals/Corrections :</td> <td><textarea name="pending_record" id="pending_record"></textarea></td></tr>
                        ...
                        <tr> <td> ALG File :</td> <td>
                                ...
                                Apln<input type="text" size="10px" name="alg_apln" id="alg_apln" readonly />
                                <input type="text" size="15px" name="alg_class" id="alg_class" readonly />
                                <input type="text" size="15px" name="alg_mark" id="alg_mark" readonly />
                            </td></tr>
                        <?php
...
//           
        ...
        if ($_POST) {
            ...
            $obj->apply_new($file_type, $app_no, $mark, $classes, $user, $filing_date, $applicant, $client, $priority_date, $jurisdiction, $goods_services, $history, $pending_record, $cl_ref_no);
        }
        ?>        
    </body>
</html>