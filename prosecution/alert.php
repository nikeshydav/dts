            ...
            <table  width="100%" id="example" >
                ...
                <tbody>
                    ...
                    while ($row = mysql_fetch_array($res)) {
                        echo '<tr id="' . $row['id'] . '"><td> &nbsp;</td><td>' . $row['alert'] . '</td><td>' . $row['all_alg_file_data'] . '</td><td>' . $row['all_alg_data'] . '</td><td>' . $row['toa'] . '</td><td>' . $row['alert_name'] . '</td></tr>';
                    }
                    ...
                    $res = mysql_query($s);
                    while ($row = mysql_fetch_array($res)) {
                        echo '<tr id="' . $row['id'] . '"><td> &nbsp;</td><td>' . $row['alert'] . '</td><td>' . $row['dummy_ref'] . '</td><td>' . $row['dummy_file'] . '</td><td>' . $row['toa'] . '</td><td>' . $row['alert_name'] . '</td></tr>';
                    }
                    ?>
                </tbody>
            </table>
