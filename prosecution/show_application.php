            ...
            <div>
                <form action="" method="post" enctype="multipart/form-data">
                    <table>
                        ...
                        <tr> <td> Application Number :</td> <td><input type="text" name="app_no" id="app_no" value="<?php echo $app_no; ?>" readonly/> </td></tr>
                        ...
                        <tr> <td> Use Claim :</td> <td><input type="text" name="user_proposed" id="" value="<?php echo $user; ?>" readonly/></td></tr>
                        ...
                        <tr> <td valign="top"> Status Prosecution :</td> <td><input type="text" size="100px" name="" id="" value="<?php echo $status; ?>" readonly/> 
                            </td></tr>
...
<input type="submit" id="submit_alg" value="Update" />
                ...
                while ($get3 = mysql_fetch_array($res3)) {
                    ...
                    echo '<form method="post"><table border="1px" style="width: 775px;"><tr><td width="125px"> ALG File :</td> <td>
                                ...
                                <input type="text" size="40px" name="alg_mark" id="alg_mark" value="' . strtoupper($alg_mark) . '" readonly />
                            </td></tr></table></form>';
                }
