    ...
    <body> <?php include_once 'include/menu.php'; ?>
        <div class="content1" id="friendslist">
            ...
            <form action="" method="post">     
                ...
                <label><input type="text" name="application_number" id="application_number" value="<?php echo $_POST['application_number'] ?>" class="tf">Application Number</label>
                ...
                </label><label><input type="text" name="status_select" id="status_select" value="<?php echo $_POST['status_select'] ?>" class="tf">Status Prosecution
                ...
                <label><input type="checkbox" <?php echo ($_POST['application_number_chk'] == "yes" ?  'checked="checked"' : '')  ?> value="yes" name="application_number_chk"  id="application_number_chk" class="tf">Application Number</label>
                ...
                </label><label><input type="checkbox" <?php echo ($_POST['status_select_chk'] == "yes" ?  'checked="checked"' : '')  ?> value="yes" name="status_select_chk"  id="status_select_chk" class="tf">Status Prosecution<br>
