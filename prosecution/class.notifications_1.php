...
class notifications {
    ...
    function notifications_list() {
       $sql = "select n.fid,a.id,a.application_no,n.status_id,s.status_name from application a,notifications-bakcup1 n, status s  where a.id=n.app_id  and s.id=n.status_id  AND n.notify_status=0";
        $res = mysql_query($sql);
        $i = 0;
