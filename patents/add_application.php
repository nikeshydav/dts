            ...
            <div>
                <form action="" method="post" enctype="multipart/form-data">
                    <table>
                        ...
                        <tr> <td> Date Of Publication :</td> <td><input type="text" name="date_of_publication" id="date_of_publication" autocomplete="off" /> </td></tr>
                        ...
                        <tr> <td> Priority :</td> <td><select  name="priority" id="priority">
                                    ...
                                    for ($index = 1; $index <= 10; $index++) {
                                        echo '<option value="' . $index . '">' . $index . 'PR</option>';
                                    }
                                    ?>
                                </select>
                                <span id="priority_options" class="priority_options"></span>                               
                            </td> </tr>
...
<tr> <td> RFE Filing Date :</td> <td><input type="text" name="rfe_filing_date" id="rfe_filing_date" autocomplete="off" /> </td></tr>
                        <tr> <td valign="top"> Status patents :</td> <td><div class="status"><p><label for="var1"><select name="status1" id="status"><option value="select">--Select--</option><?php $obj->show_status(); ?></select>
                        ...
                        <tr> <td> ALG File :</td> <td>
                                <input type="text" size="10px" name="alg_file_tyle" style="display: none;" id="alg_file_tyle" readonly /> <hr>
                                <span id="patn_file_type"></span><hr>
                                Title <input type="text" size="15px" name="alg_title" id="alg_title" readonly />
                                PR Type <input type="text" size="15px" name="alg_pr_type" id="alg_pr_type" readonly /><hr>                                
...
var clientEntityOptions = '', interOptions = '';
                ...
                $('#priority').change(function() {
                    ...
                    for (i = 1; i <= $filetypenew; i++) {
                        $('#priority_options').append('<input type="text" class="pr' + i + '" id="pr' + i + '" name="pr' + i + '"/><input type="text" id="p_d' + i + '" name="p_d' + i + '" /> <hr>');
                        $("#p_d" + i).datepicker({
                            changeMonth: true,
                            changeYear: true,
                            dateFormat: "yy-mm-dd"
...
//                    }                     
                ...
                $('#title,#client_ref_no,#applicant_ref_no').keyup(function() {
                    var title = $("#title").val();
...
//            $patn_city1 = '';
//            $patn_year2 = '';
//            $patn_digit1 .= $_POST['patn_digit1'];            
//            $patn_digit2 .= $_POST['patn_digit2'];
//            $patn_digit1 .= $_POST['patn_digit3'];
//            $patn_digit2 .= $_POST['patn_digit4'];
//            $patn_digit1 .= $_POST['patn_digit5'];
//            $patn_city1 .= $_POST['patn_city1'];
//            $patn_year2 .= $_POST['patn_year1'];
//            $patn_city1 .= $_POST['patn_city2'];
//            $patn_year2 .= $_POST['patn_year2'];
//            $patn_city1 .= $_POST['patn_city3'];
//            $patn_year2 .= $_POST['patn_year3'];
