...
<tr><td>To</td>
                      ...
                      <tr> <td> Respondent(s)' Property(ies) :</td> <td><input type="text" name="respondent_property" id="respondent_property" autocomplete="off" /> </td></tr>
                        <tr> <td valign="top"> Status Iplitigation :</td> <td><div class="status"><p><label for="var1"><select name="status1" id="status"><option value="select">--Select--</option><?php $obj->show_status(); ?></select>
