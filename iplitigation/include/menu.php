...
<div id='cssmenu'>
    <ul>
        ...
        <?php if ($_SESSION['role'] == '1' || $_SESSION['role'] == '2') { ?>
            <li class='has-sub '><a href="#" >Add New</a>
                <ul>
                    ...
                    <?php if ($_SESSION['role'] == '1') { ?>	<li class='has-sub '><a href="<?php echo'create_admin_manager.php?sid=' . mt_rand(0, 1000000); ?>" >Admin/Manager </a></li>	<?php } ?> 
        ...
        <li class='has-sub '><a href="#" ><?php echo $view; ?></a>
            <ul>
                ...
                <?php if ($_SESSION['role'] == '1') { ?><li class='has-sub '><a href="<?php echo'list_admin_mgr.php?sid=' . mt_rand(0, 1000000); ?>" >Admin/Manager </a></li><?php } ?> 
        ...
        echo $num_rows;
            ...
            <li class='has-sub '><a href="alert.php" >Alerts(<?php
                ...
                // $s="select count(*) as tot from alert a, application ap where a.toa<='" . CURRENT_MONTH_N . "' and a.toa!='0000-00-00' and a.status=0 and a.del='0000-00-00' and ap.id=a.fid";
                ...
                $ss = "select * from alert a where " . $date . " and a.toa!='0000-00-00' and a.status=0 and a.del='0000-00-00' and a.fid=0 GROUP BY a.id";

                $r = mysql_query($s);
                $num_rowss = mysql_num_rows($r);

                $ress = mysql_query($ss);
                $num_row = mysql_num_rows($ress);
                echo $num_rowss + $num_row;
                //  echo $r['tot'];
            ?>)</a></li>
                <?php } ?>
        <li class='has-sub '><a href="<?php echo'change_pass.php?sid=' . mt_rand(0, 1000000); ?>">Change Password</a></li>
